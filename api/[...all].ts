...
import { ServiceUnavailableException, UnauthorizedException, HttpException } from '@nestjs/common'
...
async function createApiServer(expressApp: ReturnType<typeof express>) {
